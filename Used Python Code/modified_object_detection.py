# Reference: https://github.com/helloyide/real-time-German-traffic-sign-recognition/blob/master/src/object_detection_test2.py
...
def test_with_image(visual_obs):
    graph_unet = tf.Graph()
    ...
    with tf.Session(graph=graph_unet) as sess_unet:
        with tf.Session(graph=graph_classifier) as sess_classifier:
            ...
            if output_dict is not None:
                ...
                return next(iter(output_dict['detection_classes']))
