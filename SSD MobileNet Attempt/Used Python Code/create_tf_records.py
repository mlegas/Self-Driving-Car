# Reference: https://github.com/aarcosg/traffic-sign-detection/blob/master/scripts/create_gtsdb_tf_record.py
#
...
def create_tf_record(output_filename,
  ...
  df['file'] = df['file'].str.replace('ppm', 'png')
...
def main(_):
  ...
  logging.info('Reading from GTSDB (600 images) + Unity (127 images) dataset.')
  image_dir = data_dir
  examples_gt_path = os.path.join(data_dir, 'gt.txt')
  examples_list = ['%05d.png' % x for x in range(727)]
